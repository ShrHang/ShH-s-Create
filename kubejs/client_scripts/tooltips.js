...
/** @type {import("net.neoforged.neoforge.event.entity.player.ItemTooltipEvent")} */
...
NativeEvents.onEvent($ItemTooltipEvent, event => {
    ...
    if (itemId == "ftbquests:book") {
        ...
        event.getToolTip().add(
            Component.translate("text.shh.common.tooltip.youcanalso").gray()
                .append(Component.translate("text.shh.common.tooltip.press_key_to", key.white(), displayName.white()))
        );
    }
})
