    ...
    if (message == 'ts') {
        ...
        */
        ...
        if (player.mainHandItem) {
            player.sendSystemMessage(Component.literal(player.mainHandItem.getComponents()).gold());
        }
        event.cancel(true);
    }
    if (message == 'tt') {
        if (player.mainHandItem) {
            player.mainHandItem.getComponents().forEach(component => {
                player.sendSystemMessage(Component.literal(component.toString()).gold());
            });
        }
    }
