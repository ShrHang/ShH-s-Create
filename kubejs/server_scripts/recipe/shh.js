ServerEvents.recipes((event) => {
    // shh:maid_tool
    event.shaped("shh:maid_tool", ["  A", " B ", "B  "], {
    ...
    event.custom({
        ...
        ingredients: [
            ...
            { type: "neoforge:single", amount: 1e3, fluid: "minecraft:milk" },
    ...
    event.shaped("shh:reality_index_upgrade_orb", ["AAA", "ABA", "AAA"], {
        A: "shhs_create_core:augmented_reality",
