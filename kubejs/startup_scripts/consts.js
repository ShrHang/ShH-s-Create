 ...
 */const $CurioBaseItem=Java.loadClass("io.redspace.ironsspellbooks.item.curios.CurioBaseItem");const $SpellContainer=Java.loadClass("io.redspace.ironsspellbooks.capabilities.magic.SpellContainer");
/**
 * 法术书类
 ...
 */const AttributeContainer=Java.loadClass("io.redspace.ironsspellbooks.item.weapons.AttributeContainer");const $SpellRegistry=Java.loadClass("io.redspace.ironsspellbooks.api.registry.SpellRegistry");const $ComponenteRegistry=Java.loadClass("io.redspace.ironsspellbooks.registries.ComponentRegistry");
//#endregion
//#region 属性名称
