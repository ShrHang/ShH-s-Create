    ...
    if (Platform.isLoaded('irons_spellbooks')) {
        ...
        // 近战武器
        {
            ...
            event.modify('irons_spellbooks:decrepit_scythe', item => {
                addAttModifiers(item, [
                    { attribute: "minecraft:generic.attack_damage", operation: 0, amount: 6, id: "shh_attack_damage:mainhand", slot: "mainhand" },
                    { attribute: "minecraft:player.entity_interaction_range", operation: 0, amount: 2, id: "shh_entity_interaction:mainhand", slot: "mainhand" }
                ]);
            });
            // 地狱战镰
            ...
            event.modify('irons_spellbooks:boreal_blade', item => {
                addAttModifiers(item, [
                    ...
                    { attribute: "minecraft:player.entity_interaction_range", operation: 0, amount: 1, id: "shh_entity_interaction:mainhand", slot: "mainhand" }
                ]);
            });
        }
        ...
        // 流浪法师套装
        {
            ...
            event.modify('irons_spellbooks:wandering_magician_helmet', item => {
                addAttModifiers(item, [
                    ...
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 50, id: "shh_max_mana:head", slot: "head" }
                ]);
            })
            // 流浪法师法袍
            event.modify('irons_spellbooks:wandering_magician_chestplate', item => {
                addAttModifiers(item, [
                    { attribute: "minecraft:generic.armor", operation: 0, amount: 3, id: "shh_armor:chest", slot: "chest" },
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 50, id: "shh_max_mana:chest", slot: "chest" }
                ]);
            })
            // 流浪法师裤子
            event.modify('irons_spellbooks:wandering_magician_leggings', item => {
                addAttModifiers(item, [
                    { attribute: "minecraft:generic.armor", operation: 0, amount: 3, id: "shh_armor:legs", slot: "legs" },
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 50, id: "shh_max_mana:legs", slot: "legs" }
                ]);
            })
            // 流浪法师靴子
            event.modify('irons_spellbooks:wandering_magician_boots', item => {
                addAttModifiers(item, [
                    ...
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 50, id: "shh_max_mana:feet", slot: "feet" }
                ]);
            })
        }
        ...
        // 术士套装
        {
            ...
            event.modify('irons_spellbooks:wizard_helmet', item => {
                addAttModifiers(item, [
                    { attribute: "minecraft:generic.armor", operation: 0, amount: 3, id: "shh_armor:head", slot: "head" },
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 75, id: "shh_max_mana:head", slot: "head" }
                ]);
            })
            // 术士法袍
            event.modify('irons_spellbooks:wizard_chestplate', item => {
                addAttModifiers(item, [
                    { attribute: "minecraft:generic.armor", operation: 0, amount: 3, id: "shh_armor:chest", slot: "chest" },
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 75, id: "shh_max_mana:chest", slot: "chest" }
                ]);
            })
            // 术士裤子
            event.modify('irons_spellbooks:wizard_leggings', item => {
                addAttModifiers(item, [
                    { attribute: "minecraft:generic.armor", operation: 0, amount: 3, id: "shh_armor:legs", slot: "legs" },
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 75, id: "shh_max_mana:legs", slot: "legs" }
                ]);
            })
            // 术士靴子
            event.modify('irons_spellbooks:wizard_boots', item => {
                addAttModifiers(item, [
                    { attribute: "minecraft:generic.armor", operation: 0, amount: 3, id: "shh_armor:feet", slot: "feet" },
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 75, id: "shh_max_mana:feet", slot: "feet" }
                ]);
            })
        }
        ...
        // 其它装备
        {
            ...
            event.modify('irons_spellbooks:tarnished_helmet', item => {
                addAttModifiers(item, [
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 125, id: "shh_max_mana:head", slot: "head" },
                    { attribute: "irons_spellbooks:spell_power", operation: 1, amount: 0.25, id: "shh_spell_power:head", slot: "head" },
                    { attribute: "l2damagetracker:magic_damage", operation: 0, amount: 0.25, id: "shh_l2_magic_damage:head", slot: "head", condition: Platform.isLoaded('l2damagetracker') }
                ]);
            })
            // 光明行者胸甲
            event.modify('irons_spellbooks:paladin_chestplate', item => {
                addAttModifiers(item, [
                    ...
                    { attribute: "irons_spellbooks:max_mana", operation: 0, amount: 75, id: "shh_max_mana:chest", slot: "chest" },
                    { attribute: "l2damagetracker:magic_damage", operation: 0, amount: 0.25, id: "shh_l2_magic_damage:chest", slot: "chest", condition: Platform.isLoaded('l2damagetracker') }
                ]);
            })
            // 迅捷之靴
