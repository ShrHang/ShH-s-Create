...
// 盾牌
event.modify("minecraft:shield",item=>{addAttModifiers(item,[{attribute:"minecraft:generic.armor",amount:6,id:"shh_armor:any"},{attribute:"minecraft:generic.knockback_resistance",amount:.1,id:"shh_nockback_resistance:any"}])});
// 剑和斧
...
// 钻石套装
pieceSlot.forEach(ps=>{event.modify(`minecraft:diamond_${ps.piece}`,item=>{addAttModifiers(item,[{attribute:"minecraft:generic.armor",amount:6,id:`shh_armor:${ps.slot}`,slot:ps.slot},{attribute:"minecraft:generic.armor_toughness",amount:1,id:`shh_armor_toughness:${ps.slot}`,slot:ps.slot},{attribute:"l2damagetracker:damage_reduction",amount:-.06,id:`shh_l2_damage_reduction:${ps.slot}`,slot:ps.slot,condition:Platform.isLoaded("l2damagetracker")}])})});
// 下界合金套装
pieceSlot.forEach(ps=>{event.modify(`minecraft:netherite_${ps.piece}`,item=>{addAttModifiers(item,[{attribute:"minecraft:generic.armor",amount:6,id:`shh_armor:${ps.slot}`,slot:ps.slot},{attribute:"minecraft:generic.armor_toughness",amount:1,id:`shh_armor_toughness:${ps.slot}`,slot:ps.slot},{attribute:"l2damagetracker:damage_reduction",amount:-.08,id:`shh_l2_damage_reduction:${ps.slot}`,slot:ps.slot,condition:Platform.isLoaded("l2damagetracker")}])})});
// 海龟壳
event.modify("minecraft:turtle_helmet",item=>{addAttModifiers(item,[{attribute:"minecraft:generic.armor",amount:3,id:"shh_armor:head",slot:"head"},{attribute:"neoforge:swim_speed",amount:.15,id:"shh_swim_speed:head",slot:"head"}])})});
